...
*/}}
{{- define "n8n.ownedEnv" -}}
DB_TYPE,DB_POSTGRESDB_HOST,DB_POSTGRESDB_PORT,DB_POSTGRESDB_DATABASE,DB_POSTGRESDB_SCHEMA,DB_POSTGRESDB_USER,DB_POSTGRESDB_PASSWORD,EXECUTIONS_MODE,N8N_PORT,N8N_PROXY_HOPS,N8N_EDITOR_BASE_URL,N8N_DEFAULT_BINARY_DATA_MODE,N8N_DIAGNOSTICS_ENABLED,N8N_WEBHOOK_URL,WEBHOOK_URL,N8N_HOST,N8N_PROTOCOL,N8N_SECURE_COOKIE,N8N_METRICS,GENERIC_TIMEZONE,TZ,N8N_ENCRYPTION_KEY
{{- end -}}
